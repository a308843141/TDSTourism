//
//  PhoneRegisteredViewController.m
//  TDSTourism
//
...
#import "TRegisteredViewController.h"

@interface PhoneRegisteredViewController ()
...
-(void)Createui{
    ...
    [self.SysjButton setTitle:@"使用电子邮件地址" forState:UIControlStateNormal];
...
-(void)SyAction:(UIButton *)SyAction {
    NSLog(@"shiyong");
    TRegisteredViewController *vpvc = [[TRegisteredViewController alloc] init];
